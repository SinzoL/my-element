...
interface MessageBoxComponentInstance {
    setVisible: (visible: boolean) => void;
    state: {
      visible: boolean;
      type: 'cancel' | 'confirm' | 'alert';
    };
  }
...
const showMessageBox = (
  ...
  // 将弹窗组件挂载到文档碎片中
  const vm = app.mount(oFragment) as unknown as MessageBoxComponentInstance;
 ...
 * @param {object} app - Vue 应用实例
 */
const hideMessageBox = (app: App): void => {
